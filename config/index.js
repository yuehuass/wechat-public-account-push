export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx94552fa0e915b4c4",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "fa460fb12346dc002d5b59fedd99a464",
  ...
  USERS: [
    {
      ...
      id: "ockGO50gmqonSrdkpx1BxH5f2MWk",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "IFtcGkbT_Fp9EAs0GLsyyBu1UAoi-hlfemjN2E9YvKs",
      // 所在省份
      province: "广东",
      // 所在城市
      city: "肇庆",
